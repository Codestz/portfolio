...
export function ProfessionalStory({ className }: ProfessionalStoryProps) {
  ...
  return (
    <section ref={triggerRef} className={className}>
      <div className="border-[4px] border-foreground bg-bg-elevated shadow-[8px_8px_0px_0px] shadow-foreground p-8 md:p-12">
        <div ref={containerRef} className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="mt-8 border-l-[6px] border-secondary bg-secondary/10 p-6">
